...
pai -name tensorflow180 
	...
	-DentryFile='./BERT/t2t_bert/distributed_gpt/export_api.py' 
	-DgpuRequired=50
	-DhyperParameters='file:///Users/xuhaotian/Desktop/my_work/BERT/t2t_bert/distributed_gpt/gpt_product_lm_export'
