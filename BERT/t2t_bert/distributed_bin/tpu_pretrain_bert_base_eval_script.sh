nohup python ./t2t_bert/distributed_bin/tpu_train_eval_api.py \
	...
	--dev_file "data_single_random_clean_gan/chunk_18.tfrecords,data_single_random_clean_gan/chunk_19.tfrecords" \
	--model_output "model/chinese_roberta_wwm_ext_L-12_H-768_A-12" \
	--epoch 5 \
	--num_classes 2 \
	--train_size 11000000 \
	--eval_size 1100000 \
