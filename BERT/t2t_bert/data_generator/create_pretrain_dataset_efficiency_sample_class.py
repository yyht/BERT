...
# def get_next_document(all_documents, es_api, doc_index, next_doc_index, 
# 					if_on_label=False):
# 	if es_api:
# 		if not if_on_label:
# 			search_body = {
# 				"query":{
# 					"match":{"doc_id":next_doc_index}
# 				}
# 			}
# 			result = es_api.search_doc(FLAGS.doc_index, search_body, threshold=0.1)
# 		else:
...
# 			}
# 			result = es_api.search_doc(FLAGS.doc_index, search_body, threshold=0.1)
# 			doc = json.loads(result[0]['source']['doc'])
# 			doc_label = json.loads(result[0]['source']['doc_label'])
# 			if np.random.random() < 0.5:
# 				search_body = {
# 					"query":{
# 						"bool":{
# 							"must":[{"match":{"doc":doc}}],
# 							"must_not":[{"match_phrase":{"doc_id":doc_index}},
# 										{"match_phrase":{"doc_label":doc_label}}]
