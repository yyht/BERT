python ./t2t_bert/pretrain_finetuning/export_checkpoints.py \
	...
	--checkpoint_path 'electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_scale_10_grl_only_mask/model.ckpt-600000' \
	--model_type 'bert' \
	--electra 'discriminator' \
	--model_scope 'bert' \
	--exclude_scope '' \
	--export_path 'electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_scale_10_grl_only_mask/discriminator/discriminator.ckpt-600000'
...
python ./t2t_bert/pretrain_finetuning/export_checkpoints.py \
	...
	--export_path 'electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_scale_10_grl_only_mask/generator/generator.ckpt-600000'
