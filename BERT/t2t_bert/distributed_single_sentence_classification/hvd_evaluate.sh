CUDA_VISIBLE_DEVICES="0" python ./t2t_bert/distributed_bin/evaluate_api.py \
	...
	--max_length 128 \
	--train_file "porn/clean_data/textcnn/distillation/train_distillation_tfrecords" \
	--dev_file "porn/clean_data/textcnn/distillation/train_distillation_tfrecords" \
