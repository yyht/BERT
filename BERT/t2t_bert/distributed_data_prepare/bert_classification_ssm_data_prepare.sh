python ./t2t_bert/distributed_data_prepare/bert_classification_prepare.py \
	...
	--train_result_file sentence_similarity/data/train_tfrecords \
	--dev_result_file sentence_similarity/data/dev_tfrecords\
	--test_result_file sentence_similarity/data/test_tfrecords\
