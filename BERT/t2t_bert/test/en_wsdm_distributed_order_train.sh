CUDA_VISIBLE_DEVICES="0,1,2,3" mpirun -np 4 \
 -H localhost:4 \
 python en_test_wsdm_distributed_order.py \
 ...
 --train_file "/data/xuht/wsdm19/postprocess/data_12_6/order_en/train.tfrecords" \
 --dev_file "/data/xuht/wsdm19/postprocess/data_12_6/order_en/dev.tfrecords" \
 --max_length 128 \
 --model_output "/data/xuht/wsdm19/postprocess/data_12_6/order_en/model_12_5" \
 --gpu_id "0" \
 --epoch 5 \
 --num_classes 3 \
 --batch_size 16 \
