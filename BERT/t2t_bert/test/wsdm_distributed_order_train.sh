CUDA_VISIBLE_DEVICES="2,3" mpirun -np 2 \
 -H localhost:2 \
 python test_wsdm_distributed_order.py \
 ...
 --train_file "/data/xuht/wsdm19/postprocess/data_12_6/order/train.tfrecords" \
 --dev_file "/data/xuht/wsdm19/postprocess/data_12_6/order/dev.tfrecords" \
 --max_length 128 \
 --model_output "/data/xuht/wsdm19/postprocess/data_12_6/order/model_12_11" \
 --gpu_id "0" \
 --epoch 5 \
 --num_classes 3 \
 --model_type "original"
