...
with graph.as_default():
    ...
    model_train_fn = bert_interaction_classifier.classifier_model_fn_builder(
                            config,
                            num_choice,
                            init_checkpoint,
                            model_reuse=None,
        ...
        while True:
            try:
                ...
                if np.mod(i, 8000) == 0:
                    ...
                    model_io_fn.save_model(sess, FLAGS.model_output+"/oqmrc_{}.ckpt".format(int(i/8000)))
                    
                    print("==successful storing model=={}".format(int(i/8000)))
                    total_loss = 0
                    cnt = 0
            except tf.errors.OutOfRangeError:
                break
