CUDA_VISIBLE_DEVICES="0" python ./t2t_bert/distributed_bin/evaluate_api.py \
	...
	--init_checkpoint "porn/clean_data/textcnn/model/estimator/distillation/modify/textcnn_0315/model.ckpt-297561" \
	...
	--model_output "porn/clean_data/textcnn/model/estimator/distillation/modify/textcnn_0315/model.ckpt-297561" \
	--epoch 8 \
	--num_classes 5 \
	--train_size 952213 \
	--eval_size 238054 \
