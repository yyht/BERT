nohup python ./t2t_bert/distributed_bin/tpu_train_eval_api.py \
	...
	--model_output "model/relgan/st/inverse_exp/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_pretrained_embedding_mixed_mask" \
	--epoch 25 \
	--num_classes 2 \
	--train_size 11000000 \
	--eval_size 1100000 \
	...
	--multi_task_config "./t2t_bert/pretrain_finetuning/multi_model_gs_gumbel_scratch_tiny.json" \
	--joint_train "1" \
