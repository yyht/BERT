nohup python ./t2t_bert/distributed_bin/tpu_train_eval_api.py \
	...
	--model_output "model/electra_bert_tiny_gen_bert_tiny_dis_joint_adam_decay_scale_10_none_sharing" \
	--epoch 15 \
	--num_classes 2 \
	--train_size 11000000 \
	--eval_size 1100000 \
	...
	--multi_task_config "./t2t_bert/pretrain_finetuning/multi_model_gs.json" \
	--joint_train "1" \
	--sharing_mode "none"
