nohup python ./t2t_bert/distributed_bin/tpu_train_eval_api.py \
	...
	--config_file "./data/textcnn/textcnn_multilingual_embedding_light_dgcnn_v1_bi.json" \
	...
	--model_output "model/gatedcnn_seq/gatedcnn_seq_light_tiny_multilingual_latest" \
	--epoch 50 \
	--num_classes 2 \
	--train_size 6000000 \
	--eval_size 1100000 \
