nohup python ./t2t_bert/distributed_bin/tpu_train_eval_api.py \
	...
	--model_output "model/group/st/constant_0.01/electra_bert_tiny_gen_bert_small_dis_joint_gumbel_no_sharing_pretrained_embedding_uniform" \
	--epoch 25 \
	--num_classes 2 \
	--train_size 11000000 \
	--eval_size 1100000 \
	...
	--multi_task_config "./t2t_bert/pretrain_finetuning/multi_model_gs_gumbel_scratch_sharing_embedding_small.json" \
	--joint_train "1" \
