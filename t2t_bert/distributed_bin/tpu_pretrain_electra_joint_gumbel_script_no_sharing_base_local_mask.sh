nohup python ./t2t_bert/distributed_bin/tpu_train_eval_api.py \
	...
	--model_output "model/grl/electra_bert_small_gen_bert_base_dis_joint_gumbel_no_sharing_base_grl_scale_10_2e-4_only_mask" \
	--epoch 15 \
	--num_classes 2 \
	--train_size 11000000 \
	--eval_size 1100000 \
	...
	--multi_task_config "./t2t_bert/pretrain_finetuning/multi_model_gs_gumbel_base.json" \
	--joint_train "1" \
