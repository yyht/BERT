nohup python ./t2t_bert/distributed_bin/tpu_train_eval_api.py \
	...
	--config_file "./data/roberta_zh_l12_albert/bert_config_tiny_non_factorized.json" \
	--init_checkpoint "model/albert_tiny_non_factorized_with_single_adam_decay_dropout/model.ckpt-214000" \
	...
	--model_output "model/albert_tiny_non_factorized_with_single_adam_decay_dropout" \
	--epoch 50 \
	--num_classes 2 \
	--train_size 11000000 \
	--eval_size 1100000 \
