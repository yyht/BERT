nohup python ./t2t_bert/distributed_bin/tpu_train_eval_api.py \
	...
	--config_file "./data/funnel_transformer/net_config_small_chinese_enc_dec.json" \
	...
	--model_output "model/tiny/bert_small_span_mask_real_attn_net_config_tiny_enc_dec" \
	--epoch 40 \
	--num_classes 2 \
	--train_size 11000000 \
	--eval_size 1100000 \
