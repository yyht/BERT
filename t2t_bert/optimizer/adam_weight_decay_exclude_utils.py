...
class DecoupledWeightDecayExtension(object):
  ...
  def __init__(self, weight_decay, exclude_from_weight_decay, **kwargs):
...
class AdamWOptimizer(DecoupledWeightDecayExtension, adam.AdamOptimizer):
  ...
  def __init__(self, weight_decay, exclude_from_weight_decay, learning_rate=0.001, beta1=0.9, beta2=0.999,
    ...
    super(AdamWOptimizer, self).__init__(
        weight_decay, exclude_from_weight_decay, learning_rate=learning_rate, beta1=beta1, beta2=beta2,
