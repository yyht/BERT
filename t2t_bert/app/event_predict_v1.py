...
model_config = {
	...
	"label2id":"/data/xuht/eventy_detection/event/model/label2id.json",
	"init_checkpoint":"/data/xuht/eventy_detection/event/model/event.ckpt",
	...
	"model_dir":"/data/xuht/eventy_detection/event/model"
...
def main():
	application = tornado.web.Application([(r"/event",PredictHandler),])
	http_server = tornado.httpserver.HTTPServer(application)
	http_server.bind(9983)
	http_server.start()
	print("-------------server start-----------------")
