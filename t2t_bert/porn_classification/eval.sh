...
python eval.py \
 ...
 --train_file "/data/xuht/websiteanalyze-data-seqing20180821/global_mining/mining_info.pkl" \
 --dev_file "/data/xuht/porn/seqing_test_20180821_tf_records" \
 --max_length 64 \
 --model_output "/data/xuht/websiteanalyze-data-seqing20180821/global_mining/" \
 --epoch 5 \
 --num_classes 5 \
 --batch_size 32 \
 --if_shard "1" \
