python ./t2t_bert/distributed_data_prepare/bert_classification_prepare.py \
	--buckets /data/xuht \
	--train_file abuse/train.txt \
	--dev_file abuse/test.txt \
	--test_file abuse/test.txt \
	--train_result_file abuse/data/train_tfrecords \
	--dev_result_file abuse/data/dev_tfrecords \
	--test_result_file abuse/data/test_tfrecords \
	...
	--label_id /data/xuht/abuse/label_dict.json \
	--lower_case "true" \
	--max_length 128 \
	--if_rule "no_rule" \
