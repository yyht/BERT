python ./t2t_bert/distributed_data_prepare/bert_classification_prepare.py \
	--buckets /data/xuht \
	--train_file xnli/train.txt \
	--dev_file xnli/dev.txt \
	--test_file xnli/test.txt \
	--train_result_file xnli/train_tfrecords \
	--dev_result_file xnli/dev_tfrecords \
	--test_result_file xnli/test_tfrecords \
	...
	--label_id /data/xuht/xnli/label_dict.json \
	--lower_case True \
	--max_length 128 \
	--if_rule "no_rule" \
