python ./t2t_bert/distributed_data_prepare/bert_distillation_data_prepare.py \
	...
	--train_result_file lcqmc/data/distillation_bpe/train_tfrecords \
	--dev_result_file lcqmc/data/distillation_bpe/dev_tfrecords\
	--test_result_file lcqmc/data/distillation_bpe/test_tfrecords\
