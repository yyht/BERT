python ./t2t_bert/distributed_data_prepare/bert_distillation_data_prepare.py \
	...
	--train_result_file lcqmc/data/distillation_unlabeled/train_tfrecords \
	--dev_result_file lcqmc/data/distillation_unlabeled/dev_tfrecords\
	--test_result_file lcqmc/data/distillation_unlabeled/test_tfrecords\
	...
	--corpus_vocab_path lcqmc/data/distillation_unlabeled/char_id.txt \
	--data_type "lcqmc" \
	--if_add_unlabeled_distillation "yes"
