python ./t2t_bert/distributed_data_prepare/pair_classification_data_prepare.py \
	--buckets /data/xuht \
	--train_file lcqmc/data/LCQMC_train.json \
	--dev_file lcqmc/data/LCQMC_dev.json \
	--test_file lcqmc/data/LCQMC_test.json \
	--train_result_file lcqmc/data/siamese/train_tfrecords \
	--dev_result_file lcqmc/data/siamese/dev_tfrecords\
	--test_result_file lcqmc/data/siamese/test_tfrecords\
	...
	--corpus_vocab_path lcqmc/data/char_id.txt \
	--data_type "lcqmc"
