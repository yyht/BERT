...
def electra_input_fn_builder(input_files,
					 max_seq_length,
					 max_predictions_per_seq,
					 is_training,
					 num_cpu_threads=4):
...
def bert_seq_input_fn_builder(input_files,
					 max_seq_length,
					 max_predictions_per_seq,
					 is_training,
					 num_cpu_threads=4):
...
def bert_mnli_input_fn_builder(input_files,
					 max_seq_length,
					 max_predictions_per_seq,
					 is_training,
					 num_cpu_threads=4):
...
def gatedcnn_pretrain_input_fn_builder(input_files,
					 max_seq_length,
					 max_predictions_per_seq,
					 is_training,
					 num_cpu_threads=4):
