...
def export_model(FLAGS,
	...
	def get_receiver_features():
		receiver_tensors = {
			"input_ori_ids":tf.placeholder(tf.int32, [None, FLAGS.max_length], name='input_ids'),
			"input_ids":tf.placeholder(tf.int32, [None, FLAGS.max_length], name='input_ori_ids'),
		}
	...
	model_fn = gatedcnn_model_fn_builder(config, num_classes, init_checkpoint, 
										model_reuse=None, 
										load_pretrained="yes",
