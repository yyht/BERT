...
python ./t2t_bert/pretrain_finetuning/export_checkpoints.py \
	...
	--checkpoint_path 'electra/joint/electra_bert_tiny_gen_bert_tiny_dis_joint_sharing_pretrained_embedding_mixed_mask/model.ckpt-1074200' \
	--model_type 'bert' \
	--electra 'discriminator' \
	--model_scope 'bert' \
	--exclude_scope '' \
	--export_path 'electra/joint/electra_bert_tiny_gen_bert_tiny_dis_joint_sharing_pretrained_embedding_mixed_mask/discriminator/discriminator.ckpt-1074200'
...
python ./t2t_bert/pretrain_finetuning/export_checkpoints.py \
	...
	--model_scope 'bert' \
	--exclude_scope 'generator' \
	--export_path 'electra/joint/electra_bert_tiny_gen_bert_tiny_dis_joint_sharing_pretrained_embedding_mixed_mask/generator/generator.ckpt-1074200'
