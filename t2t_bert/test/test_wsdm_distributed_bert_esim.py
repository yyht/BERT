...
from example import bert_esim
from example import bert_esim_v1
...
def main(_):
    ...
    with graph.as_default():
        ...
        elif FLAGS.model_type == "bert_esim":
            model_function = bert_esim.classifier_attn_model_fn_builder
        elif FLAGS.model_type == "bert_esim_v1":
            model_function = bert_esim_v1.classifier_attn_model_fn_builder
