python official_wsdm_distillation_order.py \
 --eval_data_file "/data/xuht/wsdm19/data/test.csv" \
 --output_file "/data/xuht/wsdm19/order/test.tfrecords" \
 ...
 --student_init_checkpoint "/data/xuht/wsdm19/order/distillation/model_11_24/oqmrc.ckpt" \
 --result_file "/data/xuht/wsdm19/order/distillation/model_11_24/submission.csv" \
