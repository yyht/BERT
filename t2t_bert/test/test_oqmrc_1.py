...
with graph.as_default():
    ...
    opt_config = Bunch({"init_lr":1e-5, "num_train_steps":1e30})
    ...
    params.epoch = 5
    params.batch_size = 6
    train_features = tf_data_utils.train_input_fn("/data/xuht/concat/data/train.tfrecords",
                                _decode_record, name_to_features, params)
    eval_features = tf_data_utils.eval_input_fn("/data/xuht/concat/data/test.tfrecords",
                                _decode_record, name_to_features, params)
    ...
    def eval_fn(result):
        ...
        print("test accuracy accuracy {}, loss {}, f1 score {}".format(total_accuracy/i, 
                                accuracy, total_loss/i, f1))
        return accuracy, total_loss/i
        ...
        while True:
            try:
                ...
                if np.mod(i, 40000) == 0:
                    ...
                    model_io_fn.save_model(sess, "/data/xuht/concat/data/model_11_13_0.1_inf/oqmrc_{}.ckpt".format(int(i/40000)))
                    total_loss = 0
                    cnt = 0
            except tf.errors.OutOfRangeError:
                break
    ...
    print("===========begin to eval============")
    accuracy, loss = eval_fn(result)
    print(accuracy, loss, "===result from dev set===")
    model_io_fn.save_model(sess, "/data/xuht/concat/data/model_11_13_0.1_inf/oqmrc.ckpt")
